...
def get_combination_lists(target, numeric_range, replace, save_filtered_lists):
    ...
    combinations_list = filter_numbers_used(combinations_list, target, numeric_range, replace, save_filtered_lists)
